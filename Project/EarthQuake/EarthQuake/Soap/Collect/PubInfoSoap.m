                ...
                Time:(NSString*)p_time
{
    ...
    [_soap callSoapServiceWithParameters__functionName:@"UploadDataPub"
                                                  tags:tags
                                                  vars:vars
...
-(void)retriveFromSYSoapTool:(NSMutableArray *)_data
{
    ...
    NSString *t_json                =   [[_data objectAtIndex:0]
                                         objectForKey:@"UploadDataPubResult"];
    ...
    if (_success) {
        ...
        if (_photoArr.count >0) {
            ...
            if(_videoArr.count >0){
             ...
             [_delegate pubInfoSoapDidReturn:self];
            }
        }
