...
@implementation ModifyUserSoap

-(void)ModifyUser:(NSString *)p_userName userId:(NSString *)p_userId password:(NSString *)p_userPwd name:(NSString *)p_name mobiletel:(NSString *)p_mobiletel email:(NSString *)p_email note:(NSString *)p_note imei:(NSString *)p_imei{
    ...
    [_soap callSoapServiceWithParameters__functionName:@"AlertUser"
                                                  tags:tags
                                                  vars:vars
...
-(void)retriveFromSYSoapTool:(NSMutableArray *)_data{
    ...
    if ([[jsonDic objectForKey:@"success"] boolValue]) {
        self.msg = [jsonDic objectForKey:@"msg"];
         ALERT(self.msg);
        [self.delegate ModifyUserSoapDidReturn:self];
    }else{
        self.msg = [jsonDic objectForKey:@"msg"];
        ALERT(self.msg);
    }
