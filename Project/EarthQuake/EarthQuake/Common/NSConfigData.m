...

{
    ...
    [demoView setBackgroundColor:[UIColor colorWithRed:1.0 green:1.0 blue:1.0 alpha:0.8]];
    [demoView.layer setCornerRadius:8.0];
    
    CGRect frame = CGRectMake(120, 10, 40, 40);
    UIActivityIndicatorView *progress= [[UIActivityIndicatorView alloc] initWithFrame:frame];
    [progress startAnimating];
    progress.activityIndicatorViewStyle = UIActivityIndicatorViewStyleGray;
    [demoView addSubview:progress];
    
    UILabel *label=[[UILabel alloc] initWithFrame:CGRectMake(45, 60, 200, 20)];
...
//-(MRProgressOverlayView*)getProgressView:(NSString *)p_title
//{
//    MRProgressOverlayView *progressView = [[MRProgressOverlayView alloc]init];
//    progressView.tintColor  = [UIColor colorWithRed:59.0/255.0 green:189.0/255.0 blue:193.0/255.0 alpha:1.0];
//    progressView.titleLabelText = p_title;
//    progressView.titleLabel.font = [UIFont fontWithName: @"STHeiti SC"   size : 14.0 ];
//    return progressView;
//}
